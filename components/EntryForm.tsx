        ...
        {hours > 0 && (
          ...
          >
            <input 
              ...
              placeholder={showRequired ? "Nachweis schreiben..." : "Optionaler Kommentar..."} 
              className={`w-full px-4 md:px-5 py-3 md:py-4 rounded-xl md:rounded-2xl border-none outline-none text-xs font-medium pr-10 md:pr-12 ${comment ? 'bg-gray-50' : (showRequired ? 'bg-orange-50 ring-2 ring-orange-200' : 'bg-gray-50')}`} 
            />
